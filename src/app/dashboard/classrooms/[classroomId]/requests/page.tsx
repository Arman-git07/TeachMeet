...
import { collection, query, onSnapshot, orderBy, doc, writeBatch, arrayUnion, setDoc, serverTimestamp, arrayRemove } from 'firebase/firestore';
...
import { Loader2, Check, X, ArrowLeft, UserPlus } from 'lucide-react';
            ...
            <header className="p-4 border-b flex items-center justify-between">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Approve or deny requests for this classroom.</p>
                    </div>
                </div>
