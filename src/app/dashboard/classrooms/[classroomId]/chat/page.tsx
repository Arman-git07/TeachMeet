...
export default function ClassroomChatPage({ params }: { params: { classroomId: string } }) {
  ...
  useEffect(() => {
    ...
    setMessages([
      { id: 'welcome', senderName: 'System', text: `Welcome to the chat for ${topic}.`, timestamp: new Date(), isMe: false }
    ]);
  }, [topic]);
